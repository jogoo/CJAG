...
{
		{ "repeat", required_argument, NULL, 'r', "Set the number of measurements to [y]REPEAT[/y] (default: 1000000)",
				"REPEAT" },
...
void show_usage(char *binary, int color)
{
	...
	printf("\n");
	printf_color(color, "[y]EXAMPLE[/y]\n  Start [c]%s[/c].\n\n\n", binary);
	printf_color(color, "[y]AUTHORS[/y]\n  Written by Michael Schwarz.\n\n");
